...
export const CONTENT_COMPONENTS = {
  ...
  Input: { Component: InputComponent, defaultProps: { label: 'Input', placeholder: '', required: false } },
  ...
  Button: { Component: ButtonComponent, defaultProps: { label: 'Button', variant: 'primary', actionType: 'none', apiUrl: '', apiMethod: 'POST', customAction: '', validateBeforeAction: true } },
